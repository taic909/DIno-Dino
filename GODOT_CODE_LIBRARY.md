...
The player Hurtbox detects enemy layer 2. Practice-dummy contact removes one prototype health point, applies knockback and a red flash, then grants 0.6 seconds of contact invulnerability. Current health appears in dev mode; player death is not implemented yet.
