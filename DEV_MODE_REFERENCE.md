...
- Use the **Enemy** dropdown and **Spawn** button to place a beetle or practice dummy on nearby floor ahead of the player. If no floor is found, move closer to a platform and try again.
